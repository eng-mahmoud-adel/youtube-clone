...
import { checkSubscriptionStatus, getChannelDetails } from "../../redux/actions/channel";
  ...
  return (
    <div className="videoMetaData py-2">
      ...
      <div className="videoMetaData-channel d-flex justify-content-between align-items-center my-2 py-3">
        ...
        <button className={`btn border-0 p-2 m-2 ${subscriptionStatus && 'btn-secondary'}`}>{subscriptionStatus? 'Subscribed' : 'Subscribe'}</button>
      </div>
